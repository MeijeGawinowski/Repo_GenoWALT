...
rm(list=ls())
library(genepop)
setwd("~/Documents/GenoWALT/V4_tests/Tests/HW/LOC1/size3/Fitness_Reproduction/allo0")
...
rm(list=ls())
library(genepop)
setwd("~/Documents/GenoWALT/V4_tests/Tests/HW/LOC1/size3/Fitness_Reproduction/allo0.5")
...
rm(list=ls())
library(genepop)
setwd("~/Documents/GenoWALT/V4_tests/Tests/HW/LOC1/size3/Fitness_Reproduction/allo1")
