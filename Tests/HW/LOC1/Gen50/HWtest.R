...
rm(list=ls())
library(genepop)
setwd("~/Documents/GenoWALT/V4_tests/Tests/HW/LOC1/Gen50/allo0")
...
rm(list=ls())
setwd("~/Documents/GenoWALT/V4_tests/Tests/HW/LOC1/Gen50/allo0.5")
pval <- c()
SE <- c()
WC <- c()
...
rm(list=ls())
setwd("~/Documents/GenoWALT/V4_tests/Tests/HW/LOC1/Gen50/allo1")
pval <- c()
SE <- c()
WC <- c()
...
rm(list=ls())
setwd("~/Documents/GenoWALT/V4_tests/Tests/HW/LOC1/Gen50")
