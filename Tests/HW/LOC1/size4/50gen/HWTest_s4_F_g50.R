...
rm(list=ls())
library(genepop)
setwd("~/Documents/GenoWALT/V4_tests/Tests/HW/LOC1/size4/50gen/allo0")
...
rm(list=ls())
library(genepop)
setwd("~/Documents/GenoWALT/V4_tests/Tests/HW/LOC1/size4/50gen/allo0.5")
...
rm(list=ls())
library(genepop)
setwd("~/Documents/GenoWALT/V4_tests/Tests/HW/LOC1/size4/50gen/allo1")
...
rm(list=ls())
setwd("~/Documents/GenoWALT/V4_tests/Tests/HW/LOC1/size4/50gen")
