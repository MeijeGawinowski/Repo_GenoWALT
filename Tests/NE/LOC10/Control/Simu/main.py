...
os.chdir('/home/meije/Documents/GenoWALT/V4_tests/Tests/NE/LOC10/Control/Simu')
...
for rep in range(N_rep):
	...
	os.makedirs("/home/meije/Documents/GenoWALT/V4_tests/Tests/NE/LOC10/Control/Results/sizeC/"+name_rep)
	...
	saveCSV(init_pop,sexFormatter=None,affectionFormatter=None,sep="\t",filename="/home/meije/Documents/GenoWALT/V4_tests/Tests/NE/LOC10/Control/Results/sizeC/"+name_rep+"/pop0.txt")
	for g in range(1,N_gen):
		...
		namefile = "/home/meije/Documents/GenoWALT/V4_tests/Tests/NE/LOC10/Control/Results/sizeC/"+name_rep+"/pop"+str(g)+".txt"
