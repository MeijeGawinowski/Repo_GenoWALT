...
saveCSV(init_pop,sexFormatter=None,affectionFormatter=None,genoFormatter={(0,0):"1|1",(1,0):"2|1",(0,1):"1|2",(1,1):"2|2"},sep="\t",filename="/home/meije/Documents/LD_Tests/Decrease/Control/thetaA/Rep1/pop0.txt")
for g in range(1,N_gen):
	...
	namefile = "/home/meije/Documents/LD_Tests/Decrease/Control/thetaA/Rep1/pop"+str(g)+".txt"
