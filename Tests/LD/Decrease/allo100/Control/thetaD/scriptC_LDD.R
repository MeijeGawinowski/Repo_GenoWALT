rm(list=ls())
library(pegas)
setwd("~/Documents/LD_Tests/Decrease/Control/thetaD/Rep1")
...
setwd("~/Documents/LD_Tests/Decrease/Control/thetaD/Rep2")
vect_r2 <- c()
...
setwd("~/Documents/LD_Tests/Decrease/Control/thetaD/Rep3")
vect_r3 <- c()
...
setwd("~/Documents/LD_Tests/Decrease/Control/thetaD/Rep4")
vect_r4 <- c()
...
setwd("~/Documents/LD_Tests/Decrease/Control/thetaD/Rep5")
vect_r5 <- c()
...
write.table(newdata_D,"~/Documents/LD_Tests/Decrease/Control/tabD.csv")
