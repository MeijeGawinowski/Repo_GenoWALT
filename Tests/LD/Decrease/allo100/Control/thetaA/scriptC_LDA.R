rm(list=ls())
library(pegas)
setwd("~/Documents/LD_Tests/Decrease/Control/thetaA/Rep1")
...
setwd("~/Documents/LD_Tests/Decrease/Control/thetaA/Rep2")
vect_r2 <- c()
...
setwd("~/Documents/LD_Tests/Decrease/Control/thetaA/Rep3")
vect_r3 <- c()
...
setwd("~/Documents/LD_Tests/Decrease/Control/thetaA/Rep4")
vect_r4 <- c()
...
setwd("~/Documents/LD_Tests/Decrease/Control/thetaA/Rep5")
vect_r5 <- c()
...
write.table(newdata_A,"~/Documents/LD_Tests/Decrease/Control/tabA.csv")
