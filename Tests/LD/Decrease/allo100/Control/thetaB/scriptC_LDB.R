rm(list=ls())
library(pegas)
setwd("~/Documents/LD_Tests/Decrease/Control/thetaB/Rep1")
...
setwd("~/Documents/LD_Tests/Decrease/Control/thetaB/Rep2")
vect_r2 <- c()
...
setwd("~/Documents/LD_Tests/Decrease/Control/thetaB/Rep3")
vect_r3 <- c()
...
setwd("~/Documents/LD_Tests/Decrease/Control/thetaB/Rep4")
vect_r4 <- c()
...
setwd("~/Documents/LD_Tests/Decrease/Control/thetaB/Rep5")
vect_r5 <- c()
...
write.table(newdata_B,"~/Documents/LD_Tests/Decrease/Control/tabB.csv")
