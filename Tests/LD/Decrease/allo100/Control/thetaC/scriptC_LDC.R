rm(list=ls())
library(pegas)
setwd("~/Documents/LD_Tests/Decrease/Control/thetaC/Rep1")
...
setwd("~/Documents/LD_Tests/Decrease/Control/thetaC/Rep2")
vect_r2 <- c()
...
setwd("~/Documents/LD_Tests/Decrease/Control/thetaC/Rep3")
vect_r3 <- c()
...
setwd("~/Documents/LD_Tests/Decrease/Control/thetaC/Rep4")
vect_r4 <- c()
...
setwd("~/Documents/LD_Tests/Decrease/Control/thetaC/Rep5")
vect_r5 <- c()
...
write.table(newdata_C,"~/Documents/LD_Tests/Decrease/Control/tabC.csv")
