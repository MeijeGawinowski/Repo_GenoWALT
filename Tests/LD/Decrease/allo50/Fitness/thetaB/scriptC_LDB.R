rm(list=ls())
library(pegas)
setwd("~/Documents/GenoWALT/V4_tests/Tests/LD/Decrease/allo50/Fitness/thetaB/Rep0")
...
setwd("~/Documents/GenoWALT/V4_tests/Tests/LD/Decrease/allo50/Fitness/thetaB/Rep1")
vect_r2 <- c()
...
setwd("~/Documents/GenoWALT/V4_tests/Tests/LD/Decrease/allo50/Fitness/thetaB/Rep2")
vect_r3 <- c()
...
setwd("~/Documents/GenoWALT/V4_tests/Tests/LD/Decrease/allo50/Fitness/thetaB/Rep3")
vect_r4 <- c()
...
setwd("~/Documents/GenoWALT/V4_tests/Tests/LD/Decrease/allo50/Fitness/thetaB/Rep4")
vect_r5 <- c()
...
write.table(newdata_B,"~/Documents/GenoWALT/V4_tests/Tests/LD/Decrease/allo50/Fitness/tabB.csv")
