rm(list=ls())
library(pegas)
setwd("~/Documents/GenoWALT/V4_tests/Tests/LD/Decrease/allo50/Control/thetaD/Rep0")
...
setwd("~/Documents/GenoWALT/V4_tests/Tests/LD/Decrease/allo50/Control/thetaD/Rep1")
vect_r2 <- c()
...
setwd("~/Documents/GenoWALT/V4_tests/Tests/LD/Decrease/allo50/Control/thetaD/Rep2")
vect_r3 <- c()
...
setwd("~/Documents/GenoWALT/V4_tests/Tests/LD/Decrease/allo50/Control/thetaD/Rep3")
vect_r4 <- c()
...
setwd("~/Documents/GenoWALT/V4_tests/Tests/LD/Decrease/allo50/Control/thetaD/Rep4")
vect_r5 <- c()
...
write.table(newdata_D,"~/Documents/GenoWALT/V4_tests/Tests/LD/Decrease/allo50/Control/tabD.csv")
