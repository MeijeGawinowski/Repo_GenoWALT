...
os.chdir('/home/meije/Documents/GenoWALT/V4_tests/Tests/LD/Drift/Rep100/thetaC/Fitness/Simu')
...
for rep in range(N_rep):
	...
	os.makedirs("/home/meije/Documents/GenoWALT/V4_tests/Tests/LD/Drift/Rep100/thetaC/Fitness/sizeA/Results/"+name_rep)
	...
	saveCSV(init_pop,sexFormatter=None,affectionFormatter=None,genoFormatter={(0,0):"1|1",(1,0):"2|1",(0,1):"1|2",(1,1):"2|2"},sep="\t",filename="/home/meije/Documents/GenoWALT/V4_tests/Tests/LD/Drift/Rep100/thetaC/Fitness/sizeA/Results/"+name_rep+"/pop0.txt")
	for g in range(1,N_gen):
		...
		namefile = "/home/meije/Documents/GenoWALT/V4_tests/Tests/LD/Drift/Rep100/thetaC/Fitness/sizeA/Results/"+name_rep+"/pop"+str(g)+".txt"
