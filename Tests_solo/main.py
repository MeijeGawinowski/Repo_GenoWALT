...
for g in range(N_gen):
    ...
    file_pop="/home/meije/Documents/GenoWALT/Tests_solo/Results/pop"+str(g)+".csv"
    saveCSV(parpop, filename=file_pop, infoFields=['fitness']+qtl_object.list_trt, loci=True, header=True,genoFormatter=None, infoFormatter=None, sexFormatter=None, affectionFormatter=None, sep='\t')
    #print("pop n",0," is :")
    #sim.dump(parpop)
